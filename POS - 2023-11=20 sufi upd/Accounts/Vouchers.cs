        ...
        private void button28_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (cmbtype.Text == "Payable Accounts")
                {
                    ...
                    dt.Rows.Add(acount, cmbtype.Text, pid, acountname, txtvoucherno5.Text, txtdesc5.Text, txtdebit.Text, txtcredit.Text, cmbaccount.Text);
                }
                if (cmbtype.Text == "Employees")
                {
                ...
                if (cmbtype.Text == "GL Accounts")
                {
                    ...
                    pid = "";
                    dt.Rows.Add(acount, cmbtype.Text, pid, acountname, txtvoucherno5.Text, txtdesc5.Text, txtdebit.Text, txtcredit.Text, "");
                }
                if (cmbtype.Text == "Receiveable Accounts")
                {
