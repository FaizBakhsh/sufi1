...
namespace POSRestaurant.Setting
{
    public partial class AddStore : Form
    {
        ...
        public AddStore(POSRestaurant.forms.MainForm frm)
        {
            InitializeComponent();
            this.editmode = 0;
            this.id = "";
        ...
        private void vButton2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (editmode == 0)
                {
                    ...
                    q = "insert into Stores (id,BranchId,StoreCode,StoreName) values('" + id + "','" + comboBox1.SelectedValue + "','" + txtName.Text.Trim().Replace("'", "''") + "','" + txtdescription.Text.Trim().Replace("'", "''") + "')";
