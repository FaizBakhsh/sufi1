...
{
    public partial class FrmFoodcostreport : Form
    {
        POSRestaurant.classes.Clsdbcon objCore = new classes.Clsdbcon();
        DataSet ds = new DataSet();
        public FrmFoodcostreport()
        {
            InitializeComponent();
        }
        ...
        public DataTable getAllOrdersmenuitem()
        {
            ...
            try
            {
                ...
                }
                {
                    ...
                    {
                        if (ds.Tables[0].Rows[i]["Name"].ToString().Contains("Fish Burger Single") || ds.Tables[0].Rows[i]["Name"].ToString().Contains("fish burger double") || ds.Tables[0].Rows[i]["Name"].ToString().Contains("xprs xl burger"))
                        {
