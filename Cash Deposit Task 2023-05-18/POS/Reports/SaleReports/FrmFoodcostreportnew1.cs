...
{
    public partial class FrmFoodcostreportnew1 : Form
    {
        POSRestaurant.classes.Clsdbcon objCore = new classes.Clsdbcon();
        DataSet ds = new DataSet();
        string branchtype = "";
        public FrmFoodcostreportnew1()
        {
            InitializeComponent();
        ...
        public DataTable getAllOrdersmenuitem()
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    if (dr["Name"].ToString().ToLower().Contains("extre") || dr["Name"].ToString().ToLower().Contains("zinger"))
                    {
                    ...
                    double pcost = getcostmenu1(dateTimePicker1.Text, dateTimePicker2.Text, dr["id"].ToString(), dr["Flavourid"].ToString(), dr["RunTimeModifierId"].ToString(), dr["ModifierId"].ToString(), branchtype, "Packing");
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (id.Length > 0)
                    {
                        ...
                        POSRestaurant.Reports.Inventory.Frmreceipeold obj = new Inventory.Frmreceipeold();
                        obj.menuid = id;
                        obj.flvid = flvid;
