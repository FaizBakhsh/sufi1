...
namespace POSRestaurant.Setting
{
    public partial class Closeshift : Form
    {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                DialogResult dr = MessageBox.Show("Are you sure to CLose Selected shift", "", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (dr == DialogResult.Yes)
                {
                    ...
                    string q = "update ShiftStart set status='Close' where shiftid='" + shiftid + "' and Terminal='" + terminal + "' and date='" + textBox1.Text + "'";
