    ...
    public partial class FrmCashierSale : Form
    {
        ...
        public void bindreport()
        {
            ...
            try
            {
                ...
                POSRetail.Reports.SaleReports.rprCashierSale rptDoc = new rprCashierSale();
                POSRetail.Reports.SaleReports.dsCashierSale dsrpt = new dsCashierSale();
            ...
            try
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    if (logo == "")
                    {
                        ...
                        dtrpt.Rows.Add(ds.Tables[0].Rows[i]["Name"].ToString(), ds.Tables[0].Rows[i]["count"].ToString(), ds.Tables[0].Rows[i]["sum"].ToString(), comboBox1.Text, "For the period of " + dateTimePicker1.Text + " to " + dateTimePicker2.Text, null);
                    }
                    else
                    {
                        ...
                        dtrpt.Rows.Add(ds.Tables[0].Rows[i]["Name"].ToString(), ds.Tables[0].Rows[i]["count"].ToString(), ds.Tables[0].Rows[i]["sum"].ToString(), comboBox1.Text, "For the period of " + dateTimePicker1.Text + " to " + dateTimePicker2.Text, dscompany.Tables[0].Rows[0]["logo"]);
