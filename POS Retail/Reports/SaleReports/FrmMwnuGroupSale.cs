    ...
    public partial class FrmMwnuGroupSale : Form
    {
        ...
        public void bindreport()
        {
            ...
            try
            {
                ...
                POSRetail.Reports.SaleReports.rprMenuGroupSale rptDoc = new rprMenuGroupSale();
                POSRetail.Reports.SaleReports.dsMenuGroupsale dsrpt = new dsMenuGroupsale();
        ...
        public DataTable getAllOrders()
        {
            ...
            try
            {
                ...
                {
                    q = "SELECT     SUM(dbo.Saledetails.TotalPrice) AS sum,  SUM(Saledetails.Quantity) AS count,  dbo.Brands.BrandName as name FROM         dbo.Saledetails INNER JOIN                      dbo.Sale ON dbo.Saledetails.saleid = dbo.Sale.Id INNER JOIN                      dbo.RawItem ON dbo.Saledetails.ItemId = dbo.RawItem.Id INNER JOIN                      dbo.Brands ON dbo.RawItem.BrandId = dbo.Brands.Id WHERE     (Sale.Date between '" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "') GROUP BY dbo.Brands.BrandName";
                }
                else
                {
