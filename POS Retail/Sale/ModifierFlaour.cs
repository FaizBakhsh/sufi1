...
namespace POSRetail.Sale
{
    public partial class ModifierFlaour : Form
    {
        ...
        public ModifierFlaour(Sale frm1)
           {
                InitializeComponent();
                _frm1 = frm1;
            }
            ...
            try
            {
                if (btn.Text != string.Empty)
                {
                    ...
                    if (dscallgrid.Tables[0].Rows.Count > 0)
                    {
                        ...
                        //_frm1.fillgrid(menuitemid,"", dscallgrid.Tables[0].Rows[0]["Name"].ToString()+coments, dscallgrid.Tables[0].Rows[0]["price"].ToString(), "", "New","");
                        
                        this.Close();
                        _frm1.modifier(menuitemid);
                    } 
                }
            }
            catch (Exception ex)
