...
namespace POSRetail.Setting
{
    public partial class AddCurrency : Form
    {
         ...
         public AddCurrency(POSRetail.forms.MainForm frm)
        {
            InitializeComponent();
            this.editmode = 0;
            this.id = "";
               ...
               if (txtName.Text.Trim() == string.Empty)
                ...
                DataSet ds = new DataSet();
                 if (editmode == 0)
                 {
                    ...
                    q = "insert into Currency (id,Name) values('" + id + "','" + txtName.Text.Trim().Replace("'", "''") + "')";
                ...
                if (editmode == 1)
                {
                    string q = "update Currency set Name='" + txtName.Text.Trim().Replace("'", "''") + "' where id='" + id + "'";
