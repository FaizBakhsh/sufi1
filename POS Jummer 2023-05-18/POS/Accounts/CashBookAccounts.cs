...
{
    public partial class CashBookAccounts : Form
    {
        ...
        private void AddGroups_Load(object sender, EventArgs e)
        {
            ...
            //}
            getdata("SELECT     dbo.CashBook.Id, dbo.ChartofAccounts.Name, dbo.CashBook.Type FROM         dbo.CashBook INNER JOIN                      dbo.ChartofAccounts ON dbo.CashBook.AccountId = dbo.ChartofAccounts.Id ");
        ...
        private void vButton2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (editmode == 0)
                {
                    ...
                    ds = new DataSet();
                    string q = "select * from CashBook where AccountId='" + cmbaccount.SelectedValue + "'  ";
                    ...
                    q = "insert into CashBook (AccountId, Type) values('" + cmbaccount.SelectedValue + "','" + cmbtype.Text + "')";
                ...
                if (editmode == 1)
                {
                    ...
                    string q = "update CashBook set AccountId='" + cmbaccount.SelectedValue + "',Type='" + cmbtype.Text + "' where id='" + id + "'";
                ...
                getdata("SELECT     dbo.CashBook.Id, dbo.ChartofAccounts.Name, dbo.CashBook.Type, dbo.Branch.BranchName FROM         dbo.CashBook INNER JOIN                      dbo.ChartofAccounts ON dbo.CashBook.AccountId = dbo.ChartofAccounts.Id ");
            }
            catch (Exception ex)
            {
        ...
        protected void edit()
        {
            try
            {
                if (editmode == 1)
                {
                    //POSRestaurant.classes.Clsdbcon objCore = new classes.Clsdbcon();
                    DataSet ds = new DataSet();
                    string q = "select * from CashBook where id='" + id + "'";
                    ds = objCore.funGetDataSet(q);
                    if (ds.Tables[0].Rows.Count > 0)
                    {
        ...
        private void deleteSelectedToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                string q = "delete from CashBook where id=" + id;
