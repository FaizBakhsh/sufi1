    ...
    public partial class frmaccounts : Form
    {
        ...
        public void bindreport()
        {
            ...
            try
            {
                ...
                POSRestaurant.Reports.Accounts.rptAccounts rptDoc = new rptAccounts();
                POSRestaurant.Reports.Accounts.dsaccounts dsrpt = new dsaccounts();
        ...
        public DataTable getAllOrders()
        {
            ...
            try
            {
                ...
                string q = "";
                ds = new DataSet();
                q = "SELECT     AccountType, Name, AccountCode, Description, Status FROM         ChartofAccounts where branchid='"+cmbbranchjv.SelectedValue+"' order by AccountType";
                ds = objCore.funGetDataSet(q);
