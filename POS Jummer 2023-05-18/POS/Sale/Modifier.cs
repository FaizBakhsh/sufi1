            ...
            try
            {
                if (btn.Text != string.Empty)
                {
                    ...
                    if (dscallgrid.Tables[0].Rows.Count > 0)
                    {
                        ...
                        _frm1.fillgrid(id, dscallgrid.Tables[0].Rows[0]["id"].ToString(), dscallgrid.Tables[0].Rows[0]["ModifierName"].ToString() + coments, prc.ToString(), qty.ToString(), "New", "", "", coments, "", dscallgrid.Tables[0].Rows[0]["kdsid"].ToString(), "", "", "", "",grossprc.ToString());
