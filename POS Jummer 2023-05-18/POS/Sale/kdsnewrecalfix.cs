...
{
    public partial class kdsnewrecalfix : Form
    {
        public kdsnewrecalfix()
        {
            InitializeComponent();
        }
        ...
        public void fillpending(string refresh)
        {
            ...
            if (terminal.Trim() != "")
            {
                ...
                q = "SELECT DISTINCT TOP " + top + "  dbo.Sale.id as id, dbo.Sale.Customer, dbo.Saledetails.time, dbo.Sale.terminal, dbo.Sale.TerminalOrder, dbo.Saledetails.kdsgroup FROM  dbo.Saledetails INNER JOIN               dbo.MenuItem ON dbo.Saledetails.MenuItemId = dbo.MenuItem.Id INNER JOIN              dbo.Sale ON dbo.Saledetails.saleid = dbo.Sale.Id WHERE ((dbo.Saledetails.OrderStatusmain = 'Completed') and dbo.Sale.Terminal='" + terminal + "'  AND (dbo.Saledetails.kdsgroup > 0)) or ((dbo.Saledetails.Orderstatus = 'Completed') and dbo.MenuItem.KDSId = '" + kdsid + "'  AND (dbo.Saledetails.kdsgroup > 0)) ORDER BY dbo.Sale.id desc";
                q = "SELECT DISTINCT TOP " + top + "  dbo.Sale.id as id, dbo.Sale.Customer, dbo.Sale.time, dbo.Sale.terminal, dbo.Sale.TerminalOrder, dbo.Saledetails.kdsgroup FROM  dbo.Saledetails INNER JOIN               dbo.MenuItem ON dbo.Saledetails.MenuItemId = dbo.MenuItem.Id INNER JOIN              dbo.Sale ON dbo.Saledetails.saleid = dbo.Sale.Id WHERE  ((dbo.Saledetails.Orderstatus = 'Completed') and dbo.Sale.Terminal='" + terminal + "'   and dbo.Saledetails.KDSId = '" + kdsid + "'  AND (dbo.Saledetails.kdsgroup > 0) )    or dbo.Sale.Terminal='" + terminal + "'   and  (dbo.Saledetails.Orderstatus = 'Completed') AND (dbo.Saledetails.KDSId = '0') AND (dbo.Saledetails.kdsgroup > 0)  ORDER BY dbo.Saledetails.kdsgroup desc";
              
            }
            else
            {
                q = "SELECT DISTINCT TOP " + top + "  dbo.Sale.id as id, dbo.Sale.Customer, dbo.Saledetails.time, dbo.Sale.terminal, dbo.Sale.TerminalOrder, dbo.Saledetails.kdsgroup FROM  dbo.Saledetails INNER JOIN               dbo.MenuItem ON dbo.Saledetails.MenuItemId = dbo.MenuItem.Id INNER JOIN              dbo.Sale ON dbo.Saledetails.saleid = dbo.Sale.Id WHERE (dbo.Saledetails.Orderstatus = 'Completed') AND (dbo.MenuItem.KDSId = '" + kdsid + "') AND (dbo.Saledetails.kdsgroup > 0)  or (dbo.Saledetails.Orderstatus = 'Completed') AND (dbo.MenuItem.KDSId = '0') AND (dbo.Saledetails.kdsgroup > 0) ORDER BY dbo.Saledetails.kdsgroup";
                q = "SELECT DISTINCT TOP " + top + "  dbo.Saledetails.saleid as id, dbo.Sale.Customer, dbo.Sale.time, dbo.Sale.terminal, dbo.Sale.TerminalOrder, dbo.Saledetails.kdsgroup FROM  dbo.Saledetails INNER JOIN               dbo.MenuItem ON dbo.Saledetails.MenuItemId = dbo.MenuItem.Id INNER JOIN              dbo.Sale ON dbo.Saledetails.saleid = dbo.Sale.Id WHERE (dbo.Saledetails.Orderstatus = 'Completed') AND (dbo.Saledetails.KDSId = '" + kdsid + "') AND (dbo.Saledetails.kdsgroup > 0)    or (dbo.Saledetails.Orderstatus = 'Completed') AND (dbo.Saledetails.KDSId = '0') AND (dbo.Saledetails.kdsgroup > 0)     ORDER BY dbo.Saledetails.kdsgroup desc";
            ...
            for (int i = 0; i < dspr.Tables[0].Rows.Count; i++)
            {
                ...
                q = "select * from saledetails where orderstatus='Completed'  and saleid=" + saleid;
                DataSet dsd = new DataSet();
                dsd = objCore.funGetDataSet(q);
        ...
        public DataTable getdata(string id,string group)
        {
            ...
            try
            {
                ...
                if (terminal.Trim() == "")
                {
                    q = "SELECT     dbo.Saledetails.Orderstatus,dbo.sale.Terminal,dbo.Sale.id,dbo.Saledetails.time,dbo.MenuItem.Name,dbo.MenuItem.Minutes,dbo.MenuItem.alarmtime,dbo.MenuItem.minuteskdscolor,dbo.MenuItem.alarmkdscolor, dbo.Saledetails.id as sid,dbo.Saledetails.menuitemid,dbo.Saledetails.Flavourid, dbo.Saledetails.ModifierId,dbo.Saledetails.RunTimeModifierId, dbo.Saledetails.Quantity,dbo.Saledetails.comments, dbo.MenuItem.KDSId, dbo.Sale.OrderType FROM         dbo.Sale INNER JOIN                      dbo.Saledetails ON dbo.Sale.Id = dbo.Saledetails.saleid INNER JOIN                      dbo.MenuItem ON dbo.Saledetails.MenuItemId = dbo.MenuItem.Id where  dbo.Sale.id='" + id + "' and  (dbo.Saledetails.Orderstatus = 'Completed') and dbo.Saledetails.kdsgroup ='" + group + "'  and dbo.MenuItem.KDSId='0'  order by dbo.Saledetails.id";
        ...
        private void kdsnewrecalfix_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyValue == 65)
            {
                this.Close();
