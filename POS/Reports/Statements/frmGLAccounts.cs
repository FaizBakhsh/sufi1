        ...
        public DataTable getAllOrders()
        {
            ...
            try
            {
                ...
                if (cmbaccount.Text.ToLower() == "all")
                {
                    ...
                    {
                        qr = "select id,name,AccountType from ChartofAccounts where status='active'  order by name";
                    }
                    else
                    {
                        if (cmbsubhead.Text == "All")
                        {
                            ...
                            {
                                qr = "select id,name,AccountType from ChartofAccounts where status='active'  and AccountType like '%" + cmbhead.Text + "%' order by name";
                            }
                            else
                            {
                                qr = "select id,name,AccountType from ChartofAccounts where status='active'  and SubAccount='" + cmbsubaccount.Text + "' and AccountType like '%" + cmbhead.Text + "%' order by name";
                            }
                        }
                        else
                        {
                            ...
                            {
                                qr = "select id,name,AccountType from ChartofAccounts where status='active'  and AccountType = '" + cmbsubhead.Text + "' order by name";
                            }
                            else
                            {
                                qr = "select id,name,AccountType from ChartofAccounts where status='active'  and SubAccount='" + cmbsubaccount.Text + "'  and AccountType = '" + cmbsubhead.Text + "' order by name";
                            }
                ...
                {
                    qr = "select id,name,AccountType from ChartofAccounts where id='" + cmbaccount.SelectedValue + "' ";
                }
                ...
                for (int k = 0; k < dsaccounts.Tables[0].Rows.Count; k++)
                {
                    ...
                    string AccountType = dsaccounts.Tables[0].Rows[k]["AccountType"].ToString();
                    string logo = "";
                    try
                    {
                        logo = dscompany.Tables[0].Rows[0]["logo"].ToString();
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (cmbbranchjv.Text == "All")
                        {
                            if (AccountType.Contains("Expenses"))
                            {
                            ...
                            {
                                q = "SELECT    Date,branchid,  Voucherno,  Description, Debit, Credit, CurrentBalance FROM        CashAccountPaymentSupplier  where SupplierId='" + acid + "' and date between'" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "' ORDER BY  Date, VoucherNo";
                            }
                        ...
                        else
                        {
                            ...
                            {
                              q = "SELECT    Date,branchid,  Voucherno,  Description, Debit, Credit, CurrentBalance FROM         CashAccountPaymentSupplier where SupplierId='" + acid + "' and branchid='" + cmbbranchjv.SelectedValue + "' and date between'" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "' ORDER BY  Date, VoucherNo";
                            }
                        }
                        ds = objCore.funGetDataSet(q);
                    ...
                    ds = new DataSet();
                    q = "";
                    //Cash Sale - Bank Sale - Account Receiveable
                    if (cmbbranchjv.Text == "All")
                    {
                        if (acid == "7")
                        {
                            q = "SELECT    Date,branchid,  Voucherno,  Description, Debit, Credit, Balance FROM         CashAccountSales where ChartAccountId='" + "56" + "' and date between'" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "' ORDER BY  Date, VoucherNo";
                        }
                    }
                    else
                    {
                        if (acid == "7")
                        {
                            q = "SELECT    Date,branchid,  Voucherno,  Description, Debit, Credit, Balance FROM         CashAccountSales where ChartAccountId='" + "56" + "' and branchid='" + cmbbranchjv.SelectedValue + "' and date between'" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "' ORDER BY  Date, VoucherNo";
                        }
                    }
                    ds.Dispose(); ds = new DataSet();
                    ...
                    if (cmbbranchjv.Text == "All")
                    {
                        if (acid == "7")
                        {
                            q = "SELECT    Date,branchid,  Voucherno,  Description, Debit, Credit, Balance FROM         CashAccountSales where ChartAccountId='" + "45" + "' and date between'" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "' ORDER BY  Date, VoucherNo";
                        }
                    }
                    else
                    {
                        if (acid == "7")
                        {
                            q = "SELECT    Date,branchid,  Voucherno,  Description, Debit, Credit, Balance FROM         CashAccountSales where ChartAccountId='" + "45" + "' and branchid='" + cmbbranchjv.SelectedValue + "' and date between'" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "' ORDER BY  Date, VoucherNo";
                        }
                    }
                    ...
                    if (cmbbranchjv.Text == "All")
                    {
                        if (acid == "7")
                        {
                            q = "SELECT    Date,branchid,  Voucherno,  Description, Debit, Credit, Balance FROM         SupplierAccount where PayableAccountId='" + "4" + "' and date between'" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "' ORDER BY  Date, VoucherNo";
                        }
                    ...
                    else
                    {
                        if (acid == "7")
                        {
                            q = "SELECT    Date,branchid,  Voucherno,  Description, Debit, Credit, Balance FROM         SupplierAccount where PayableAccountId='" + "4" + "' and branchid='" + cmbbranchjv.SelectedValue + "' and date between'" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "' ORDER BY  Date, VoucherNo";
                        }
                    }
                    if (!string.IsNullOrEmpty(q))
                    {
