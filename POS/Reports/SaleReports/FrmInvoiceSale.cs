...
namespace POSRestaurant.Reports.SaleReports
{
    public partial class FrmInvoiceSale : Form
    {
        ...
        private void FrmMwnuGroupSale_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataSet ds2 = new DataSet();
                 q = "select top 1 BranchName,type from Branch where status='Active' and Branchcode = '1001'";
                ds2 = objCore.funGetDataSet(q);
                Type = Convert.ToString(ds2.Tables[0].Rows[0]["type"]);
            }
            catch (Exception ex)
            {
                    ...
                    if (cmbordertype.Text == "All")
                    {
                        if (checkBox1.Checked == true)
                        {
                            if (cmbtype.Text == "All")
                            {
                                if (cmbshift.Text == "All")
                                {
                                    q = "SELECT        dbo.Sale.FBRcode,dbo.Sale.time,dbo.Sale.OrderType,  dbo.Sale.Id,dbo.Sale.onlineid, dbo.Sale.Date,dbo.Sale.TotalBill,dbo.Sale.GST, dbo.Sale.Customer, dbo.Sale.TerminalOrder, dbo.Sale.Terminal, dbo.Shifts.Name, dbo.BillType.type +' ' +ISNULL(c.Name,'') AS type, dbo.BillType.Amount, dbo.Sale.DiscountAmount, dbo.BillType.cashoutime,invoice FROM            dbo.Sale INNER JOIN                         dbo.Shifts ON dbo.Sale.Shiftid = dbo.Shifts.Id INNER JOIN                         dbo.BillType ON dbo.Sale.Id = dbo.BillType.saleid left join dbo.Customers c ON c.Id=BillType.recvid where dbo.sale.date between '" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "' and dbo.sale.branchid='" + cmbbranch.SelectedValue + "' and LEN(FBRcode) > 0  order by dbo.sale.id";
                                }
                                else
                                {
                        ...
                        else
                        {
                            if (checkBox1.Checked == true)
                            {
                                if (cmbtype.Text == "All")
                                {
                                    if (cmbshift.Text == "All")
                                    {
                                        q = "SELECT        dbo.Sale.FBRcode,dbo.Sale.time,dbo.Sale.OrderType,  dbo.Sale.Id, dbo.Sale.OnlineId, dbo.Sale.Date, dbo.Sale.TotalBill, dbo.Sale.GST, dbo.Sale.Customer, dbo.Sale.TerminalOrder, dbo.Sale.Terminal, dbo.Shifts.Name, dbo.BillType.type +' ' +ISNULL(c.Name,'') AS type, dbo.BillType.Amount,                          dbo.Sale.DiscountAmount, dbo.BillType.cashoutime, dbo.DineInTableDesign.Floor,invoice FROM            dbo.Sale INNER JOIN                         dbo.Shifts ON dbo.Sale.Shiftid = dbo.Shifts.Id INNER JOIN                         dbo.BillType ON dbo.Sale.Id = dbo.BillType.saleid INNER JOIN                         dbo.DineInTableDesign ON dbo.Sale.Customer = dbo.DineInTableDesign.TableNo left join dbo.Customers c ON c.Id=BillType.recvid where dbo.sale.date between '" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "' and dbo.sale.branchid='" + cmbbranch.SelectedValue + "' and LEN(FBRcode) > 0  and dbo.sale.OrderType='" + cmbordertype.Text + "'  and dbo.DineInTableDesign.Floor='" + cmbfloors.Text + "'  order by dbo.sale.id";
                                    }
                                    else
                                    {
                                        q = "SELECT        dbo.Sale.FBRcode,dbo.Sale.time,dbo.Sale.OrderType,  dbo.Sale.Id, dbo.Sale.OnlineId, dbo.Sale.Date, dbo.Sale.TotalBill, dbo.Sale.GST, dbo.Sale.Customer, dbo.Sale.TerminalOrder, dbo.Sale.Terminal, dbo.Shifts.Name, dbo.BillType.type +' ' +ISNULL(c.Name,'') AS type, dbo.BillType.Amount,                          dbo.Sale.DiscountAmount, dbo.BillType.cashoutime, dbo.DineInTableDesign.Floor,invoice FROM            dbo.Sale INNER JOIN                         dbo.Shifts ON dbo.Sale.Shiftid = dbo.Shifts.Id INNER JOIN                         dbo.BillType ON dbo.Sale.Id = dbo.BillType.saleid INNER JOIN                         dbo.DineInTableDesign ON dbo.Sale.Customer = dbo.DineInTableDesign.TableNo  left join dbo.Customers c ON c.Id=BillType.recvid where dbo.sale.date between '" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "' and dbo.sale.branchid='" + cmbbranch.SelectedValue + "'  and dbo.sale.shiftid='" + cmbshift.SelectedValue + "'  and LEN(FBRcode) > 0  and dbo.sale.OrderType='" + cmbordertype.Text + "'  and dbo.DineInTableDesign.Floor='" + cmbfloors.Text + "'  order by dbo.sale.id";
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        if (cmbshift.Text == "All")
                                        {
                                            q = "SELECT        dbo.Sale.FBRcode,dbo.Sale.time,dbo.Sale.OrderType,  dbo.Sale.Id, dbo.Sale.OnlineId, dbo.Sale.Date, dbo.Sale.TotalBill, dbo.Sale.GST, dbo.Sale.Customer, dbo.Sale.TerminalOrder, dbo.Sale.Terminal, dbo.Shifts.Name, dbo.BillType.type +' ' +ISNULL(c.Name,'') AS type, dbo.BillType.Amount,                          dbo.Sale.DiscountAmount, dbo.BillType.cashoutime, dbo.DineInTableDesign.Floor,invoice FROM            dbo.Sale INNER JOIN                         dbo.Shifts ON dbo.Sale.Shiftid = dbo.Shifts.Id INNER JOIN                         dbo.BillType ON dbo.Sale.Id = dbo.BillType.saleid INNER JOIN                         dbo.DineInTableDesign ON dbo.Sale.Customer = dbo.DineInTableDesign.TableNo left join dbo.Customers c ON c.Id=BillType.recvidleft join dbo.Customers c ON c.Id=BillType.recvid  where dbo.sale.date between '" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "' and dbo.sale.branchid='" + cmbbranch.SelectedValue + "'  and dbo.Sale.BillType like '%" + cmbtype.Text + "%' and dbo.sale.OrderType='" + cmbordertype.Text + "'  and dbo.DineInTableDesign.Floor='" + cmbfloors.Text + "'  order by dbo.sale.id";
                                        }
                                        else
                                        {
                                            q = "SELECT        dbo.Sale.FBRcode,dbo.Sale.time, dbo.Sale.OrderType, dbo.Sale.Id, dbo.Sale.OnlineId, dbo.Sale.Date, dbo.Sale.TotalBill, dbo.Sale.GST, dbo.Sale.Customer, dbo.Sale.TerminalOrder, dbo.Sale.Terminal, dbo.Shifts.Name, dbo.BillType.type +' ' +ISNULL(c.Name,'') AS type, dbo.BillType.Amount,                          dbo.Sale.DiscountAmount, dbo.BillType.cashoutime, dbo.DineInTableDesign.Floor,invoice FROM            dbo.Sale INNER JOIN                         dbo.Shifts ON dbo.Sale.Shiftid = dbo.Shifts.Id INNER JOIN                         dbo.BillType ON dbo.Sale.Id = dbo.BillType.saleid INNER JOIN                         dbo.DineInTableDesign ON dbo.Sale.Customer = dbo.DineInTableDesign.TableNo left join dbo.Customers c ON c.Id=BillType.recvid where dbo.sale.date between '" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "' and dbo.sale.branchid='" + cmbbranch.SelectedValue + "'  and dbo.sale.shiftid='" + cmbshift.SelectedValue + "'  and dbo.Sale.BillType like '%" + cmbtype.Text + "%'  and dbo.sale.OrderType='" + cmbordertype.Text + "'  and dbo.DineInTableDesign.Floor='" + cmbfloors.Text + "'  order by dbo.sale.id";
        ...
        public DataTable getAllOrdersHHO()
        {
                    ...
                    if (cmbordertype.Text == "All")
                    {
                        if (checkBox1.Checked == true)
                        {
                            if (cmbtype.Text == "All")
                            {
                                if (cmbshift.Text == "All")
                                {
                                    q = "SELECT        dbo.Sale.FBRcode,dbo.Sale.time,dbo.Sale.OrderType,  dbo.Sale.Id,dbo.Sale.onlineid, dbo.Sale.Date,dbo.Sale.TotalBill,dbo.Sale.GST, dbo.Sale.Customer, dbo.Sale.TerminalOrder, dbo.Sale.Terminal, dbo.Shifts.Name, dbo.BillType.type, dbo.BillType.Amount, dbo.Sale.DiscountAmount, dbo.BillType.cashoutime,invoice FROM            dbo.Sale INNER JOIN                         dbo.Shifts ON dbo.Sale.Shiftid = dbo.Shifts.Id INNER JOIN                         dbo.BillType ON dbo.Sale.onlineid = dbo.BillType.saleid where dbo.sale.date between '" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "' and dbo.sale.branchid='" + cmbbranch.SelectedValue + "' and LEN(FBRcode) > 0  order by dbo.sale.id";
                                }
                                else
                                {
                                    q = "SELECT        dbo.Sale.FBRcode,dbo.Sale.time,dbo.Sale.OrderType,  dbo.Sale.Id,dbo.Sale.onlineid,  dbo.Sale.Date,dbo.Sale.TotalBill,dbo.Sale.GST, dbo.Sale.Customer, dbo.Sale.TerminalOrder, dbo.Sale.Terminal, dbo.Shifts.Name, dbo.BillType.type, dbo.BillType.Amount, dbo.Sale.DiscountAmount, dbo.BillType.cashoutime,invoice FROM            dbo.Sale INNER JOIN                         dbo.Shifts ON dbo.Sale.Shiftid = dbo.Shifts.Id INNER JOIN                         dbo.BillType ON dbo.Sale.onlineid = dbo.BillType.saleid  where dbo.sale.date between '" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "' and dbo.sale.branchid='" + cmbbranch.SelectedValue + "'  and dbo.sale.shiftid='" + cmbshift.SelectedValue + "'  and LEN(FBRcode) > 0  order by dbo.sale.id";
                        ...
                        else
                        {
                            if (checkBox1.Checked == true)
                            {
                                if (cmbtype.Text == "All")
                                {
                                    if (cmbshift.Text == "All")
                                    {
                                        q = "SELECT        dbo.Sale.FBRcode,dbo.Sale.time,dbo.Sale.OrderType,  dbo.Sale.Id, dbo.Sale.OnlineId, dbo.Sale.Date, dbo.Sale.TotalBill, dbo.Sale.GST, dbo.Sale.Customer, dbo.Sale.TerminalOrder, dbo.Sale.Terminal, dbo.Shifts.Name, dbo.BillType.type, dbo.BillType.Amount,                          dbo.Sale.DiscountAmount, dbo.BillType.cashoutime, dbo.DineInTableDesign.Floor,invoice FROM            dbo.Sale INNER JOIN                         dbo.Shifts ON dbo.Sale.Shiftid = dbo.Shifts.Id INNER JOIN                         dbo.BillType ON dbo.Sale.onlineid = dbo.BillType.saleid INNER JOIN                         dbo.DineInTableDesign ON dbo.Sale.Customer = dbo.DineInTableDesign.TableNo where dbo.sale.date between '" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "' and dbo.sale.branchid='" + cmbbranch.SelectedValue + "' and LEN(FBRcode) > 0  and dbo.sale.OrderType='" + cmbordertype.Text + "'  and dbo.DineInTableDesign.Floor='" + cmbfloors.Text + "'  order by dbo.sale.id";
                                    }
                                    else
                                    {
                                        q = "SELECT        dbo.Sale.FBRcode,dbo.Sale.time,dbo.Sale.OrderType,  dbo.Sale.Id, dbo.Sale.OnlineId, dbo.Sale.Date, dbo.Sale.TotalBill, dbo.Sale.GST, dbo.Sale.Customer, dbo.Sale.TerminalOrder, dbo.Sale.Terminal, dbo.Shifts.Name, dbo.BillType.type, dbo.BillType.Amount,                          dbo.Sale.DiscountAmount, dbo.BillType.cashoutime, dbo.DineInTableDesign.Floor,invoice FROM            dbo.Sale INNER JOIN                         dbo.Shifts ON dbo.Sale.Shiftid = dbo.Shifts.Id INNER JOIN                         dbo.BillType ON dbo.Sale.onlineid = dbo.BillType.saleid INNER JOIN                         dbo.DineInTableDesign ON dbo.Sale.Customer = dbo.DineInTableDesign.TableNo   where dbo.sale.date between '" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "' and dbo.sale.branchid='" + cmbbranch.SelectedValue + "'  and dbo.sale.shiftid='" + cmbshift.SelectedValue + "'  and LEN(FBRcode) > 0  and dbo.sale.OrderType='" + cmbordertype.Text + "'  and dbo.DineInTableDesign.Floor='" + cmbfloors.Text + "'  order by dbo.sale.id";
