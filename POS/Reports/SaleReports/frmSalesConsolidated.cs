            ...
            try
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                   ...
                   // discount = (amnt * discount) / 100; 
                    ...
                    if (logo == "")
                    {
                        dtrpt.Rows.Add(ds.Tables[0].Rows[i]["MenuGroup"].ToString(), ds.Tables[0].Rows[i]["MenuItem"].ToString(), ds.Tables[0].Rows[i]["name"].ToString(), ds.Tables[0].Rows[i]["modifier"].ToString(), ds.Tables[0].Rows[i]["RuntimeModifier"].ToString(), qty, amnt, null, discount, gst, net, billno, user, date, Convert.ToString(ds.Tables[0].Rows[i]["Code"]));
                    }
                    else
                    {
                        dtrpt.Rows.Add(ds.Tables[0].Rows[i]["MenuGroup"].ToString(), ds.Tables[0].Rows[i]["MenuItem"].ToString(), ds.Tables[0].Rows[i]["name"].ToString(), ds.Tables[0].Rows[i]["modifier"].ToString(), ds.Tables[0].Rows[i]["RuntimeModifier"].ToString(), qty, amnt, dscompany.Tables[0].Rows[0]["logo"], discount, gst, net, billno, user, date, Convert.ToString(ds.Tables[0].Rows[i]["Code"]));
                    }
                }
            }
            catch (Exception ex)
