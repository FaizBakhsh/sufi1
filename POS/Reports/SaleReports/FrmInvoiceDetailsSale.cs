        ...
        public DataTable getAllOrders()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    try
                    {
                        dtrpt.Rows.Add(ds.Tables[0].Rows[i]["invoice"].ToString(), name, qty, amount, gst, dis, total, ds.Tables[0].Rows[i]["date"].ToString());
