    ...
    public partial class FrmcustomerSale : Form
    {
        ...
        private void FrmMwnuGroupSale_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                q = "select id,branchname from branch ";
                ds1 = objCore.funGetDataSet(q);
                DataRow dr1 = ds1.Tables[0].NewRow();
                dr1["branchname"] = "All";
                // ds1.Tables[0].Rows.Add(dr1);
               ddlBranch.DataSource = ds1.Tables[0];
               ddlBranch.ValueMember = "id";
        ...
        public DataTable getAllOrders()
        {
            ...
            try
            {
                ...
                if (saleid == "")
                {
                    ...
                    {
                        string BillType = ddlType.SelectedText;
                        if (BillType == "Visa")
                            BillType = "Card";
                        else
                            BillType = "Cash";

                     q = "SELECT       DISTINCT dbo.Saledetails.Price AS sum, dbo.Saledetails.Quantity AS count, dbo.Saledetails.Itemdiscount AS dis, dbo.Sale.Id,dbo.Sale.date, dbo.Saledetails.ItemGst AS gs, dbo.MenuItem.Name + '  ' + dbo.Saledetails.comments AS name, dbo.MenuItem.Id AS mid, dbo.ModifierFlavour.name AS Expr1, dbo.Saledetails.comments, dbo.Sale.Customer FROM            dbo.Saledetails INNER JOIN                         dbo.MenuItem ON dbo.Saledetails.MenuItemId = dbo.MenuItem.Id INNER JOIN                         dbo.Sale ON dbo.Saledetails.saleid = dbo.Sale.Id  LEFT OUTER JOIN                         dbo.ModifierFlavour ON dbo.Saledetails.Flavourid = dbo.ModifierFlavour.Id INNER JOIN dbo.BillType b ON dbo.Sale.Id=b.saleid INNER JOIN dbo.Customers c ON c.Id=b.recvid WHERE     (Sale.Date between '" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "') and Sale.BillStatus='paid'  and dbo.Saledetails.ModifierId=0 and dbo.Saledetails.RunTimeModifierId=0   and dbo.Sale.branchid='" + ddlBranch.SelectedValue + "' AND dbo.Sale.GSTtype ='"+BillType+"' ";
                    ...
                    else
                    {
                        ...
                        if (comboBox1.Text == "All")
                        {
                            ...
                            q = "SELECT       DISTINCT dbo.Saledetails.Price AS sum, dbo.Saledetails.Quantity AS count, dbo.Saledetails.Itemdiscount AS dis, dbo.Sale.Id,dbo.Sale.date, dbo.Saledetails.ItemGst AS gs,                          dbo.MenuItem.Name + '  ' + dbo.Saledetails.comments AS name, dbo.MenuItem.Id AS mid, dbo.ModifierFlavour.name AS Expr1, dbo.Saledetails.comments, dbo.Sale.Customer FROM            dbo.Saledetails INNER JOIN                         dbo.MenuItem ON dbo.Saledetails.MenuItemId = dbo.MenuItem.Id INNER JOIN                         dbo.Sale ON dbo.Saledetails.saleid = dbo.Sale.Id  LEFT OUTER JOIN                         dbo.ModifierFlavour ON dbo.Saledetails.Flavourid = dbo.ModifierFlavour.Id INNER JOIN dbo.BillType b ON dbo.Sale.Id=b.saleid INNER JOIN dbo.Customers c ON c.Id=b.recvid WHERE     (Sale.Date between '" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "') and Sale.BillStatus='paid'  and dbo.Saledetails.ModifierId=0 and dbo.Saledetails.RunTimeModifierId=0   and dbo.Sale.branchid='" + ddlBranch.SelectedValue + "' ";
                        ...
                        {
                            q = "SELECT       DISTINCT dbo.Saledetails.Price AS sum, dbo.Saledetails.Quantity AS count, dbo.Saledetails.Itemdiscount AS dis, dbo.Sale.Id,dbo.Sale.date, dbo.Saledetails.ItemGst AS gs,                          dbo.MenuItem.Name + '  ' + dbo.Saledetails.comments AS name, dbo.MenuItem.Id AS mid, dbo.ModifierFlavour.name AS Expr1, dbo.Saledetails.comments, dbo.Sale.Customer FROM            dbo.Saledetails INNER JOIN                         dbo.MenuItem ON dbo.Saledetails.MenuItemId = dbo.MenuItem.Id INNER JOIN                         dbo.Sale ON dbo.Saledetails.saleid = dbo.Sale.Id  LEFT OUTER JOIN                         dbo.ModifierFlavour ON dbo.Saledetails.Flavourid = dbo.ModifierFlavour.Id INNER JOIN dbo.BillType b ON dbo.Sale.Id=b.saleid INNER JOIN dbo.Customers c ON c.Id=b.recvid WHERE     (Sale.Date between '" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "') and c.Name= '" + comboBox1.Text + "' and Sale.BillStatus='paid'  and dbo.Saledetails.ModifierId=0 and dbo.Saledetails.RunTimeModifierId=0  and dbo.Sale.branchid='" + ddlBranch.SelectedValue + "' ";
