                ...
                if (cmbgroupraw.Text == "All")
                {
                    if (cmbkitchen.Text == "All")
                    {
                        if (cmbitem.Text == "All")
                        {
                            ...
                            {
                                q = "SELECT        dbo.RawItem.Id, dbo.RawItem.ItemName, dbo.RawItem.Price, dbo.UOM.UOM, dbo.RawItem.MinOrder FROM            dbo.RawItem INNER JOIN                         dbo.UOM ON dbo.RawItem.UOMId = dbo.UOM.Id where dbo.RawItem.Status='Active' or dbo.RawItem.Status is NULL order by dbo.RawItem.ItemName";
                            }
                            else
                            {
                                q = "SELECT DISTINCT dbo.RawItem.Id, dbo.RawItem.ItemName, dbo.RawItem.MinOrder, dbo.UOM.UOM FROM            dbo.Recipe INNER JOIN                         dbo.RawItem ON dbo.Recipe.RawItemId = dbo.RawItem.Id INNER JOIN                         dbo.MenuItem ON dbo.Recipe.MenuItemId = dbo.MenuItem.Id INNER JOIN                         dbo.UOM ON dbo.RawItem.UOMId = dbo.UOM.Id WHERE  (dbo.RawItem.Status='Active' or dbo.RawItem.Status is NULL)   and  (dbo.MenuItem.Status = 'active')  and  dbo.MenuItem.MenuGroupId='" + cmbgroup.SelectedValue + "'  order by dbo.RawItem.ItemName";
                            }
                        }
                        else
                        {
                    ...
                    else
                    {
                        if (cmbitem.Text == "All")
                        {
                            ...
                            if (cmbgroup.Text == "All")
                            {
                                q = "SELECT DISTINCT dbo.RawItem.Id, dbo.RawItem.ItemName, dbo.RawItem.MinOrder, dbo.UOM.UOM FROM            dbo.Recipe INNER JOIN                         dbo.RawItem ON dbo.Recipe.RawItemId = dbo.RawItem.Id INNER JOIN                         dbo.MenuItem ON dbo.Recipe.MenuItemId = dbo.MenuItem.Id INNER JOIN                         dbo.UOM ON dbo.RawItem.UOMId = dbo.UOM.Id WHERE    (dbo.RawItem.Status='Active' or dbo.RawItem.Status is NULL)   and     (dbo.MenuItem.Status = 'active') and   dbo.MenuItem.KDSId='" + cmbkitchen.SelectedValue + "'  order by dbo.RawItem.ItemName";                             
                            }
                            else
                            {
                                q = "SELECT DISTINCT dbo.RawItem.Id, dbo.RawItem.ItemName, dbo.RawItem.MinOrder, dbo.UOM.UOM FROM            dbo.Recipe INNER JOIN                         dbo.RawItem ON dbo.Recipe.RawItemId = dbo.RawItem.Id INNER JOIN                         dbo.MenuItem ON dbo.Recipe.MenuItemId = dbo.MenuItem.Id INNER JOIN                         dbo.UOM ON dbo.RawItem.UOMId = dbo.UOM.Id WHERE    (dbo.RawItem.Status='Active' or dbo.RawItem.Status is NULL)   and     (dbo.MenuItem.Status = 'active') and  dbo.MenuItem.menugroupid='" + cmbgroup.SelectedValue + "' and  dbo.MenuItem.KDSId='" + cmbkitchen.SelectedValue + "'    order by dbo.RawItem.ItemName";
                ...
                else
                {
                    if (cmbkitchen.Text == "All")
                    {
                        if (cmbitem.Text == "All")
                        {
                            if (cmbgroup.Text == "All")
                            {
                                ...
                                q = "SELECT        dbo.RawItem.Id, dbo.RawItem.ItemName, dbo.RawItem.Price, dbo.UOM.UOM, dbo.RawItem.MinOrder FROM            dbo.RawItem INNER JOIN                         dbo.UOM ON dbo.RawItem.UOMId = dbo.UOM.Id  where (dbo.RawItem.Status='Active' or dbo.RawItem.Status is NULL)   and  dbo.RawItem.CategoryId='" + cmbgroupraw.SelectedValue + "'  order by dbo.RawItem.ItemName";
                            }
                            else
                            {
                                q = "SELECT DISTINCT dbo.RawItem.Id, dbo.RawItem.ItemName, dbo.RawItem.MinOrder, dbo.UOM.UOM FROM            dbo.Recipe INNER JOIN                         dbo.RawItem ON dbo.Recipe.RawItemId = dbo.RawItem.Id INNER JOIN                         dbo.MenuItem ON dbo.Recipe.MenuItemId = dbo.MenuItem.Id INNER JOIN                         dbo.UOM ON dbo.RawItem.UOMId = dbo.UOM.Id WHERE   (dbo.RawItem.Status='Active' or dbo.RawItem.Status is NULL)   and      (dbo.MenuItem.Status = 'active')  and  dbo.MenuItem.MenuGroupId='" + cmbgroup.SelectedValue + "' and dbo.RawItem.CategoryId='" + cmbgroupraw.SelectedValue + "'  order by dbo.RawItem.ItemName";
                    ...
                    else
                    {
                        if (cmbitem.Text == "All")
                        {
                            if (cmbgroup.Text == "All")
                            {
                                q = "SELECT DISTINCT dbo.RawItem.Id, dbo.RawItem.ItemName, dbo.RawItem.MinOrder, dbo.UOM.UOM FROM            dbo.Recipe INNER JOIN                         dbo.RawItem ON dbo.Recipe.RawItemId = dbo.RawItem.Id INNER JOIN                         dbo.MenuItem ON dbo.Recipe.MenuItemId = dbo.MenuItem.Id INNER JOIN                         dbo.UOM ON dbo.RawItem.UOMId = dbo.UOM.Id WHERE  (dbo.RawItem.Status='Active' or dbo.RawItem.Status is NULL)   and    dbo.RawItem.CategoryId='" + cmbgroupraw.SelectedValue + "' and     (dbo.MenuItem.Status = 'active') and  dbo.MenuItem.KDSId='" + cmbkitchen.SelectedValue + "' order by dbo.RawItem.ItemName";
                               // q = "SELECT        dbo.RawItem.Id, dbo.RawItem.ItemName, dbo.RawItem.Price, dbo.UOM.UOM, dbo.RawItem.MinOrder FROM            dbo.RawItem INNER JOIN                         dbo.UOM ON dbo.RawItem.UOMId = dbo.UOM.Id  where dbo.RawItem.CategoryId='" + cmbgroupraw.SelectedValue + "'  order by dbo.RawItem.ItemName";

                            }
                            else
                            {
                                q = "SELECT DISTINCT dbo.RawItem.Id, dbo.RawItem.ItemName, dbo.RawItem.MinOrder, dbo.UOM.UOM FROM            dbo.Recipe INNER JOIN                         dbo.RawItem ON dbo.Recipe.RawItemId = dbo.RawItem.Id INNER JOIN                         dbo.MenuItem ON dbo.Recipe.MenuItemId = dbo.MenuItem.Id INNER JOIN                         dbo.UOM ON dbo.RawItem.UOMId = dbo.UOM.Id WHERE  (dbo.RawItem.Status='Active' or dbo.RawItem.Status is NULL)   and    dbo.RawItem.CategoryId='" + cmbgroupraw.SelectedValue + "' and     (dbo.MenuItem.Status = 'active')  and  dbo.MenuItem.MenuGroupId='" + cmbgroup.SelectedValue + "' and dbo.MenuItem.KDSId='" + cmbkitchen.SelectedValue + "' order by dbo.RawItem.ItemName";
                               // q = "SELECT        dbo.RawItem.Id, dbo.RawItem.ItemName, dbo.RawItem.Price, dbo.UOM.UOM, dbo.RawItem.MinOrder FROM            dbo.RawItem INNER JOIN                         dbo.UOM ON dbo.RawItem.UOMId = dbo.UOM.Id where  dbo.RawItem.CategoryId='" + cmbgroupraw.SelectedValue + "' order by dbo.RawItem.ItemName";
