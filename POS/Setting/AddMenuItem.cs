             ...
             try
             {
                 ...
                 if (editmode == 0)
                 {
                     ...
                     if (imageData == null)
                     {
                         ...
                         {
                             q = "insert into MenuItem (OptionalModifier,kdsid2,ManualQty,grossprice,currentmargin,proposedprice,ProposedMargin,startdate,enddate,modifiercount, Target,id,Name,Code,BarCode,MenuGroupId,Price,status,ColorId,FontColorId,FontSize,Minutes,alarmtime,minuteskdscolor,alarmkdscolor,KDSId) values('" + cmboptional.Text + "','" + kdsid2 + "','" + cmbmanual.Text + "','" + txtprice.Text + "','" + txtcurentmargin.Text + "','" + txtproposedprice.Text + "','" + txtproposedmargin.Text + "','" + dateTimePicker1.Text + "','" + dateTimePicker2.Text + "','" + txtmodifier.Text + "','" + txttarget.Text + "','" + id + "',N'" + name.Trim().Replace("'", "''") + "','','" + richTextBox1.Text.Trim().Replace("'", "''") + "','" + comboBox1.SelectedValue + "','" + richTextBox2.Text.Trim().Replace("'", "''") + "','" + cmbstatus.Text.Replace("'", "''") + "','" + cmbcolor.SelectedValue + "','" + comboBox2.SelectedValue + "','" + comboBox3.Text + "','" + txttime.Text + "','" + txtalarmtime.Text + "','" + textBox1.Text + "','" + textBox2.Text + "','" + comboBox4.SelectedValue + "')";
                         }
                         else if (checkBox2.Checked == true)
                         {
                             q = "insert into MenuItem (OptionalModifier,kdsid2,ManualQty,grossprice,currentmargin,proposedprice,ProposedMargin,startdate,modifiercount, Target,id,Name,Code,BarCode,MenuGroupId,Price,status,ColorId,FontColorId,FontSize,Minutes,alarmtime,minuteskdscolor,alarmkdscolor,KDSId) values('" + cmboptional.Text + "','" + kdsid2 + "','" + cmbmanual.Text + "','" + txtprice.Text + "','" + txtcurentmargin.Text + "','" + txtproposedprice.Text + "','" + txtproposedmargin.Text + "','" + dateTimePicker1.Text + "','" + txtmodifier.Text + "','" + txttarget.Text + "','" + id + "',N'" + name.Trim().Replace("'", "''") + "','','" + richTextBox1.Text.Trim().Replace("'", "''") + "','" + comboBox1.SelectedValue + "','" + richTextBox2.Text.Trim().Replace("'", "''") + "','" + cmbstatus.Text.Replace("'", "''") + "','" + cmbcolor.SelectedValue + "','" + comboBox2.SelectedValue + "','" + comboBox3.Text + "','" + txttime.Text + "','" + txtalarmtime.Text + "','" + textBox1.Text + "','" + textBox2.Text + "','" + comboBox4.SelectedValue + "')";

                         }
                         else if (checkBox3.Checked == true)
                         {
                             q = "insert into MenuItem (OptionalModifier,kdsid2,ManualQty,grossprice,currentmargin,proposedprice,ProposedMargin,enddate,modifiercount, Target,id,Name,Code,BarCode,MenuGroupId,Price,status,ColorId,FontColorId,FontSize,Minutes,alarmtime,minuteskdscolor,alarmkdscolor,KDSId) values('" + cmboptional.Text + "','" + kdsid2 + "','" + cmbmanual.Text + "','" + txtprice.Text + "','" + txtcurentmargin.Text + "','" + txtproposedprice.Text + "','" + txtproposedmargin.Text + "','" + dateTimePicker2.Text + "','" + txtmodifier.Text + "','" + txttarget.Text + "','" + id + "',N'" + name.Trim().Replace("'", "''") + "','','" + richTextBox1.Text.Trim().Replace("'", "''") + "','" + comboBox1.SelectedValue + "','" + richTextBox2.Text.Trim().Replace("'", "''") + "','" + cmbstatus.Text.Replace("'", "''") + "','" + cmbcolor.SelectedValue + "','" + comboBox2.SelectedValue + "','" + comboBox3.Text + "','" + txttime.Text + "','" + txtalarmtime.Text + "','" + textBox1.Text + "','" + textBox2.Text + "','" + comboBox4.SelectedValue + "')";

                         }
                         else
                         {
                             q = "insert into MenuItem (OptionalModifier,kdsid2,ManualQty,grossprice,currentmargin,proposedprice,ProposedMargin,modifiercount, Target,id,Name,Code,BarCode,MenuGroupId,Price,status,ColorId,FontColorId,FontSize,Minutes,alarmtime,minuteskdscolor,alarmkdscolor,KDSId,Price2) values('" + cmboptional.Text + "','" + kdsid2 + "','" + cmbmanual.Text + "','" + txtprice.Text + "','" + txtcurentmargin.Text + "','" + txtproposedprice.Text + "','" + txtproposedmargin.Text + "','" + txtmodifier.Text + "','" + txttarget.Text + "','" + id + "',N'" + name.Trim().Replace("'", "''") + "','','" + richTextBox1.Text.Trim().Replace("'", "''") + "','" + comboBox1.SelectedValue + "','" + richTextBox2.Text.Trim().Replace("'", "''") + "','" + cmbstatus.Text.Replace("'", "''") + "','" + cmbcolor.SelectedValue + "','" + comboBox2.SelectedValue + "','" + comboBox3.Text + "','" + txttime.Text + "','" + txtalarmtime.Text + "','" + textBox1.Text + "','" + textBox2.Text + "','" + comboBox4.SelectedValue + "','" + txtprice2.Text + "')";
                 ...
                 if (editmode == 1)
                 {
                     ...
                     else
                     {
                         ...
                         //@imagespath + "\\" + fname
                         pictureBox1.Image.Save(imagePaths);
                     }
