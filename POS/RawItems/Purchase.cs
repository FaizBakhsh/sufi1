    ...
    public partial class Purchase : Form
    {
        ...
        private void vButton1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (txtGST.Text.Trim().Length > 0)
                {
                    GstAmt = Convert.ToDouble(txtGST.Text);
                }
            ...
            try
            {
                if (dataGridView1.Rows.Count > 0)
                {
                    ...
                    if (textBox1.Text == string.Empty)
                    {
                        ...
                        string q = "insert into Purchase (PONo,id,SupplierId,TotalAmount,Date,BranchCode,StoreCode,InvoiceNo,GstAmount) values('" + txtpo.Text + "','" + id + "','" + cmbsupplier.SelectedValue + "','" + tamount + "','" + dateTimePicker1.Text.Trim() + "','" + cmbbranch.SelectedValue + "','" + cmbstore.SelectedValue + "','" + txtinvoice.Text.Trim().Replace("'", "''") + "','" + txtGST.Text + "')";
        ...
        public void supplieraccount(string amount)
        {
            try
            {
                ...
                if (dsacount.Tables[0].Rows.Count > 0)
                {
                    ...
                    double balance = 0;
                    string val = "";
                    q = "insert into SupplierAccount (invoiceno,Id,Date,SupplierId,PayableAccountId,VoucherNo,Description,Debit,Credit,Balance,branchid) values('" + textBox1.Text + "-" + txtinvoice.Text + "','" + iddd + "','" + dateTimePicker1.Text + "','" + cmbsupplier.SelectedValue + "','" + PayableAccountId + "','GRN-" + textBox1.Text + "-" + cmbbranch.SelectedValue + "','Purchase against Invoice No " + txtinvoice.Text.Trim().Replace("'", "''") + "','0','" + (Math.Round(Convert.ToDouble(amount), 2) + Math.Round(Convert.ToDouble(GstAmt), 2)) + "','0','" + cmbbranch.SelectedValue + "')";
                    objCore.executeQuery(q);
        ...
        public void GsTaccount(string amount)
        {
            try
            {

                DataSet dsacount = new DataSet();
                string q = "select id from ChartofAccounts where Name='GST Account (Receiveable)'";
                dsacount = objCore.funGetDataSet(q);
                if (dsacount.Tables[0].Rows.Count > 0)
                {
                    string PayableAccountId = dsacount.Tables[0].Rows[0][0].ToString();
                    ...
                    double balance = 0;
                    string val = "";
                    q = "insert into GSTAccount (Id,Date,ChartAccountId,VoucherNo,Description,Debit,Credit,Balance,branchid) values('" + iddd + "','" + dateTimePicker1.Text + "','" + PayableAccountId + "','GRN-" + textBox1.Text + "-" + cmbbranch.SelectedValue + "','Purchase against Invoice No " + txtinvoice.Text.Trim().Replace("'", "''") + "','" + Math.Round(Convert.ToDouble(amount), 2) + "','0','0','" + cmbbranch.SelectedValue + "')";
                    objCore.executeQuery(q);
                    txtGST.Text = "0";
                }
            }
        ...
        public void paycashaccount(string amount)
        {
            try
            {
...

                {
                    ...
                    {
                        string q1 = "insert into CashAccountPaymentSupplier (id,Date,ChartAccountId,SupplierId,Voucherno,Description,Debit,Credit,branchid) values('" + idd + "','" + dateTimePicker1.Text + "','" + ChartAccountId + "','" + cmbsupplier.SelectedValue + "','CPV-GRN-" + textBox1.Text + "','Cash Paid against GRN-" + textBox1.Text.Trim() + "','0','" + (Math.Round(Convert.ToDouble(prc), 2) + Math.Round(Convert.ToDouble(GstAmt), 2)) + "','" + cmbbranch.SelectedValue + "')";
                        ...
                        string q2 = "insert into SupplierAccount (Id,Date,SupplierId,PayableAccountId,VoucherNo,Description,Debit,Credit,branchid) values('" + iddd + "','" + dateTimePicker1.Text + "','" + cmbsupplier.SelectedValue + "','" + PayableAccountId + "','CPV-GRN-" + textBox1.Text + "','Cash Paid against GRN-" + textBox1.Text.Trim() + "','" + (Math.Round(Convert.ToDouble(prc), 2) +Math.Round(Convert.ToDouble(GstAmt),2))+ "','0','" + cmbbranch.SelectedValue + "')";
