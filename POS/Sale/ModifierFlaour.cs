            ...
            try
            {
                if (btn.Text != string.Empty)
                {
                    ...
                    if (dscallgrid.Tables[0].Rows.Count > 0)
                    {
                        ...
                        prce = prce * quantity;
                        _frm1.fillgrid(menuitemid, "", dscallgrid.Tables[0].Rows[0]["Name"].ToString() + coments, prce.ToString(), quantity.ToString(), "New", "", dscallgrid.Tables[0].Rows[0]["id"].ToString(), "", "", dscallgrid.Tables[0].Rows[0]["kdsid"].ToString(), "", "", "", "");
                        _frm1.Enabled = true;
                        this.Close();
